                        ...
                        <div class="product-img-large">
                            <div class="img-large-slider common-slider" data-slick='{
                                ...
                                <div class="img-large-wrapper">
                                    <a href="/src/assets/img/products/bags/39.jpg" data-fancybox="gallery">
                                        <img src="/src/assets/img/products/bags/39.jpg" alt="img">
                                    </a>
                                </div>
                                <div class="img-large-wrapper">
                                    <a href="/src/assets/img/products/bags/38.jpg" data-fancybox="gallery">
                                        <img src="/src/assets/img/products/bags/38.jpg" alt="img">
                                    </a>
                                </div>
                                <div class="img-large-wrapper">
                                    <a href="/src/assets/img/products/bags/37.jpg" data-fancybox="gallery">
                                        <img src="/src/assets/img/products/bags/37.jpg" alt="img">
                                    </a>
                                </div>
                                <div class="img-large-wrapper">
                                    <a href="/src/assets/img/products/bags/36.jpg" data-fancybox="gallery">
                                        <img src="/src/assets/img/products/bags/36.jpg" alt="img">
                                    </a>
                                </div>
                                <div class="img-large-wrapper">
                                    <a href="/src/assets/img/products/bags/34.jpg" data-fancybox="gallery">
                                        <img src="/src/assets/img/products/bags/34.jpg" alt="img">
                                    </a>
                                </div>
                                <div class="img-large-wrapper">
                                    <a href="/src/assets/img/products/bags/30.jpg" data-fancybox="gallery">
                                        <img src="/src/assets/img/products/bags/30.jpg" alt="img">
                                    </a>
                                </div>
                                <div class="img-large-wrapper">
                                    <a href="/src/assets/img/products/bags/32.jpg" data-fancybox="gallery">
                ...
                <div class="common-slider" data-slick='{
                        ...
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/11.jpg" alt="product-img">
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/22.jpg" alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/2.jpg" alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/23.jpg" alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/3.jpg" alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/26.jpg" alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/4.jpg" alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/27.jpg" alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/5.jpg" alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/29.jpg" alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/6.jpg" alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/17.jpg" alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/7.jpg" alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/18.jpg" alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/8.jpg" alt="product-img">
                                </a>
