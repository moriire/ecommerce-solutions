    ...
    <div class="product-page mt-100">
        <div class="container">
            <div class="row">
                ...
                <ProductSingle :item="prod.product" @addCart="prod.addToCart(prod.product)"
            ...
            <div class="tab-content product-tab-content">
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-12 col-12">
                            <div class="desc-content">
                                ...
                                <p class="text_16 mb-4">Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do
                                    eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu
                                    fugiat nulla pariatur. Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed
                                    do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem ipsum dolor sit
                                    amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
                        ...
                        <div class="col-lg-5 col-md-12 col-12">
                            <div class="desc-img">
                                <img src="/src/assets/img/product.jpg" alt="img">
                            </div>
                        </div>
                ...
                <div id="pstyle" class="tab-pane fade">
                    <div class="desc-content">
                        ...
                        <p class="text_16 mb-4">You have to pay for return shipping if you want to exchange your product
                            for another size or the package is returned because it has not been picked up at the post
                            office.</p>
                    </div>
                </div>
                ...
                <div class="common-slider" data-slick='{
                        ...
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/11.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/1.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/22.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/2.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/23.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/3.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/26.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/4.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/27.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/5.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/29.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/6.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/17.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/7.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="/src/assets/img/products/bags/18.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="/src/assets/img/products/bags/8.jpg"
                                        alt="product-img">
                                </a>
