                    ...
                    <div class="form-check col-lg-4 col-md-12 col-12">
                      <fieldset class=".d-flex ">
                        ...
                        <div class="d-flex">
                          ...
                          <input v-model="prodcrud.productData.condition" id="new" type="radio" class="form-check"
                            value="new" />
                    ...
                    <div class="col-lg-4 col-md-12 col-12">
                      <fieldset>
                        ...
                        <select class="form-select" v-model="prodcrud.productData.category">
                          <option :selected="index == 0 ? 'selected' : ''" v-for="(cat, index) in categories"
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                      <fieldset>
                        ...
                        <select class="form-select" v-model="prodcrud.productData.package">
                          <option :selected="index == 0 ? 'selected' : ''" v-for="(pkg, index) in packages"
